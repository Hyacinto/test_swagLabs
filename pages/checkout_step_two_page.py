...
class Checkout_step_two:
    def __init__(self, driver):
        ...
        self.prices_checkout = Utilities.price_list(driver)
        self.descriptions_checkout = Utilities.description_list(driver)
        self.titles_checkout =  Utilities.title_list(driver)
        self.finish_button = driver.find_element(By.ID,"finish")
        self.back_to_button = driver.find_element(By.ID,"cancel")

    @property
    def calculate_total_price(self):
        return sum(self.prices_checkout,start=0)
